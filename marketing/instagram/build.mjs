...
:root {
  color-scheme: light;
  --plane: #EAF1F0; --plane-glow-1: #E1EBEA; --plane-glow-2: #D6E3E2;
  --surface: #FFFFFF; --surface-raised: #FFFFFF; --surface-sunken: #D6E3E2;
  --ink: #101A18; --ink-secondary: #41544F; --ink-muted: #4B5E5A;
  --line: #C3D2CF; --line-strong: #93A8A3; --grid: #D3E0DE;
  --accent-glow: #3FBF93; --accent: #1E7D63; --accent-ink: #F4FBF8; --accent-text: #17614D;
  --accent-quiet: rgba(30, 125, 99, 0.14); --brand-bridge: #5E9B57;
  --series-1: #1E7D63; --series-2: #0B5FB0; --series-3: #A93C06; --reference: #4B5E5A;
  --good: #0A6E0A; --warning: #7A4F00; --critical: #B3261E; --delta-up: #0F6B0F; --delta-down: #A81E1E;
  ...
  --atmo:
    ...
    linear-gradient(180deg, #E1EBEA, #D6E3E2 55%, #BFD5D2);
...
:root[data-theme="dark"] {
  color-scheme: dark;
  --plane: #0B1014; --plane-glow-1: #0E1418; --plane-glow-2: #070A0D;
  --surface: #141C21; --surface-raised: #1B252B; --surface-sunken: #070A0D;
  --ink: #F2F7F8; --ink-secondary: #BFCCD0; --ink-muted: #90A0A4;
  --line: #2F3A3F; --line-strong: #46555B; --grid: #1B2429;
  --accent-glow: #A6F0CE; --accent: #7FE5B5; --accent-ink: #06100B; --accent-text: #7FE5B5;
  --accent-quiet: rgba(127, 229, 181, 0.18); --brand-bridge: #5E9B57;
  --series-1: #7FE5B5; --series-2: #4FB6FF; --series-3: #FF9448; --reference: #90A0A4;
  --good: #2FB85E; --warning: #E89312; --critical: #FF6B5E; --delta-up: #35C167; --delta-down: #FF7F72;
  ...
  --atmo:
    ...
    linear-gradient(180deg, #0E1418, #0B1014 55%, #070A0D);
  --shadow-hue: 0 0 0;
