...
export function LanguageToggle() {
  ...
  return (
    <label className="inline-flex h-11 items-center gap-2 border border-line bg-surface-sunken pl-3 pr-2">
      ...
      <select
        ...
        className="h-full appearance-none bg-transparent pr-6 font-display text-[12px] font-semibold tracking-[0.08em] uppercase text-ink outline-none"
