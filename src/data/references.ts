...
const BASE_REFERENCES: ReferenceEntry[] = [
  // ======================= BEVÖLKERUNG =====================================
  {
    ...
    mean: 34.17,
    sd: 2.75,
    source: { study: 'VO2max Athletes vs Nonathletes (Kontrollgruppe)', n: null, license: 'published_values' },
    quality: 'B',
  ...
  },
  {
    ...
    mean: 47.4,
    sd: 6.0,
    source: { study: 'VO2max-Schätzungsvergleich, aktive gesunde Erwachsene', n: 99, license: 'published_values' },
    quality: 'B',
  },
  ...
  // Quelle — der Eintrag entfällt und steht in REFERENCE_GAPS.
  {
    ...
    method: 'median',
    median: 49.5,
    source: { study: 'Peterman et al. 2019, Mayo Clin Proc, FRIEND-I (Laufband)', n: 44007, license: 'published_table' },
    quality: 'B',
    protocolNote: LAB_NOTE,
  },
  {
  ...
  // Bezugswert statt Perzentil — der Abstand zum Gipfel ist die Aussage.
  {
    ...
    method: 'anchor',
    anchor: 51,
    source: { study: 'Dodds et al. 2014, PLoS ONE, zwölf britische Bevölkerungsstudien', n: 49964, license: 'open_access' },
    quality: 'A',
  },
  {
    testSlug: 'grip_strength',
  ...
  },
  {
    ...
    method: 'anchor',
    anchor: 49.7,
    source: { study: 'NIH Toolbox US', n: 1232, license: 'unclear' },
    quality: 'A',
  },
  {
    testSlug: 'grip_strength',
  ...
  // ======================= KAMPFSPORT ======================================
  {
    ...
    source: { study: 'Meta-Analyse SJFT, 37 Studien', n: 724, license: 'published_values' },
    quality: 'A',
  },
  {
    testSlug: '*',
    ...
    source: { study: 'Review Physical/Physiological Characteristics Judo', n: null, license: 'published_values' },
    quality: 'B',
    protocolNote: LAB_NOTE,
  },
  {
    ...
    source: { study: 'Systematic Review BJJ', n: null, license: 'published_values' },
    quality: 'B',
    protocolNote: LAB_NOTE,
  },
  {
    ...
    mean: 54.4,
    sd: 13.4,
    source: { study: 'Review-Zitat aus Primärstudie, Gi Grip Endurance', n: null, license: 'published_values' },
    quality: 'C',
    protocolNote: {
  ...
  },
  {
    ...
    mean: 63.23,
    sd: 5.5,
    source: { study: 'Anthropometric/Physiological Profile Elite MMA', n: null, license: 'published_values' },
    quality: 'C',
    protocolNote: LAB_NOTE,
  },
  {
    ...
    source: { study: 'Anthropometric/Physiological Profile Elite MMA, Chin-up-Test', n: null, license: 'published_values' },
    quality: 'C',
  },
  {
    testSlug: 'sprint_10m',
    ...
    mean: 1.97,
    sd: 0.06,
    source: { study: 'Maximal Strength/Sprint/Jump Study, Photozellen', n: null, license: 'published_values' },
    quality: 'C',
    protocolNote: {
  ...
  },
  {
    ...
    mean: 33.3,
    sd: 9.6,
    source: { study: 'Fitness Assessment of Fencers', n: null, license: 'published_values' },
    quality: 'C',
  },
  {
    testSlug: '*',
    ...
    mean: 49.63,
    sd: 4.95,
    source: { study: 'Regionale Studien (u. a. Bumi Siliwangi)', n: null, license: 'unclear' },
    quality: 'C',
  },
  ...
  // ======================= AUSDAUER ========================================
  {
    ...
    mean: 56.5,
    sd: 6.2,
    source: { study: 'Marathon Performance in Female Distance Runners', n: 35, license: 'published_values' },
    quality: 'B',
    protocolNote: LAB_NOTE,
  },
  ...
  // ======================= RADSPORT ========================================
  {
    ...
    mean: 352,
    sd: 49,
    source: { study: 'Reliability/Validity FTP20', n: 22, license: 'published_values' },
    quality: 'B',
    protocolNote: {
