...
const COMBAT: Discipline[] = [
  {
    ...
    tests: [
      ...
      addedOptional('combat_rounds', 'Runden in Wettkampflänge, jede einzeln gezählt: wie viel in der letzten Runde noch übrig ist.'),
    ],
...
const HYBRID: Discipline[] = [
  {
    ...
    tests: [
      ...
      addedOptional('hyrox_simulation', 'Das ganze Format unter festen eigenen Bedingungen: Laufabfall und Stationsanteile im Verlauf, nur gegen die eigenen Simulationen.'),
