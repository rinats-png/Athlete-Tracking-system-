...
const COMBAT: Discipline[] = [
  {
    ...
    coreTests: ['special_judo_fitness_test', 'grip_strength', 'pull_up_max_reps', 'deadlift_1rm', 'countermovement_jump'],
    optionalTests: ['grip_hang_time', 'repeated_throws_30s', 'run_1_5_mile', 'shuttle_5_10_5'],
  ...
  },
  {
    ...
    coreTests: ['grip_strength', 'pull_up_max_reps', 'repeated_throws_30s', 'deadlift_1rm', 'plank_hold'],
    optionalTests: ['grip_hang_time', 'countermovement_jump', 'shuttle_5_10_5', 'run_1_5_mile'],
  ...
  },
  {
    ...
    coreTests: ['grip_strength', 'grip_hang_time', 'pull_up_max_reps', 'plank_hold', 'run_1_5_mile'],
    optionalTests: ['deadlift_1rm', 'cindy_20min_amrap'],
  ...
  },
  {
    ...
    coreTests: ['punch_test_60s', 'plank_hold', 'run_1_5_mile', 'countermovement_jump', 'shuttle_5_10_5'],
    optionalTests: ['grip_strength', 'pull_up_max_reps', 'assault_bike_10min_cal'],
  ...
  },
  {
    ...
    coreTests: ['kick_test_60s', 'countermovement_jump', 'run_1_5_mile', 'shuttle_5_10_5', 'plank_hold'],
    optionalTests: ['punch_test_60s', 'standing_broad_jump', 'assault_bike_10min_cal'],
    eventDurationSeconds: [540, 720],
    typicalLimiter: 'strength_endurance',
  },
  {
    ...
    coreTests: ['kick_test_60s', 'countermovement_jump', 'shuttle_5_10_5', 'sprint_10m', 'standing_broad_jump'],
    optionalTests: ['t_test_agility', 'run_1_5_mile', 'repeated_jump_15s'],
    eventDurationSeconds: [360, 360],
  ...
  },
  {
    ...
    coreTests: ['grip_strength', 'pull_up_max_reps', 'punch_test_60s', 'countermovement_jump', 'run_1_5_mile', 'deadlift_1rm'],
    optionalTests: ['repeated_throws_30s', 'plank_hold', 'shuttle_5_10_5', 'assault_bike_10min_cal'],
  ...
  },
  {
    ...
    coreTests: ['countermovement_jump', 'sprint_10m', 'shuttle_5_10_5', 'punch_test_60s', 'standing_broad_jump'],
    optionalTests: ['t_test_agility', 'kick_test_60s', 'run_1_5_mile'],
  ...
  },
  {
    ...
    coreTests: ['grip_strength', 'repeated_throws_30s', 'countermovement_jump', 'pull_up_max_reps', 'run_1_5_mile'],
    optionalTests: ['punch_test_60s', 'plank_hold', 'shuttle_5_10_5'],
  ...
  },
  {
    ...
    coreTests: ['countermovement_jump', 'shuttle_5_10_5', 'sprint_10m', 'plank_hold', 'run_1_5_mile'],
    optionalTests: ['kick_test_60s', 'standing_broad_jump'],
    eventDurationSeconds: [180, 180],
  ...
  },
  {
    ...
    coreTests: ['shuttle_5_10_5', 'sprint_10m', 'countermovement_jump', 't_test_agility', 'standing_broad_jump'],
    optionalTests: ['repeated_jump_15s', 'run_1_5_mile', 'plank_hold'],
...
const HYBRID: Discipline[] = [
  {
    ...
    coreTests: ['run_5k', 'farmers_carry', 'sled_push', 'wall_balls_75', 'row_1000m'],
    optionalTests: ['run_1_5_mile', 'assault_bike_10min_cal', 'deadlift_1rm', 'burpee_broad_jump_80m'],
  ...
  },
  {
    ...
    coreTests: ['cindy_20min_amrap', 'back_squat_1rm', 'clean_and_jerk_1rm', 'row_2000m', 'pull_up_max_reps'],
    optionalTests: ['assault_bike_10min_cal', 'fran', 'grace', 'countermovement_jump', 'run_5k'],
  ...
  },
  {
    ...
    coreTests: ['run_5k', 'grip_hang_time', 'pull_up_max_reps', 'farmers_carry', 'grip_strength'],
    optionalTests: ['sled_push', 'run_1_5_mile', 'plank_hold'],
...
const RUNNING: Discipline[] = [
  {
    ...
    coreTests: ['run_5k', 'cooper_12min', 'threshold_run_30min'],
    optionalTests: ['sprint_30m', 'countermovement_jump', 'beep_test_20m'],
  ...
  },
  {
    ...
    optionalTests: ['run_5k', 'beep_test_20m'],
  ...
  },
  {
    ...
    coreTests: ['threshold_run_30min', 'run_10k', 'run_5k'],
    optionalTests: ['cooper_12min', 'plank_hold', 'lactate_step_test'],
  ...
  },
  {
    ...
    coreTests: ['run_10k', 'threshold_run_30min', 'plank_hold', 'repeated_jump_15s'],
    optionalTests: ['run_5k', 'standing_broad_jump', 'farmers_carry'],
  ...
  },
  {
    ...
    coreTests: ['threshold_run_30min', 'run_10k', 'plank_hold'],
    optionalTests: ['run_5k', 'lactate_step_test', 'farmers_carry'],
...
const CYCLING: Discipline[] = [
  {
    ...
    coreTests: ['ftp_20min', 'ramp_test_bike', 'peak_power_5s'],
    optionalTests: ['assault_bike_10min_cal', 'lactate_step_test', 'row_2000m'],
    eventDurationSeconds: [7200, 21600],
    typicalLimiter: 'endurance',
  },
  {
    ...
    optionalTests: ['lactate_step_test', 'peak_power_5s'],
  ...
  },
  {
    ...
    coreTests: ['ftp_20min', 'peak_power_5s', 'ramp_test_bike', 'plank_hold'],
    optionalTests: ['wingate_30s', 'grip_strength'],
  ...
  },
  {
    ...
    coreTests: ['ftp_20min', 'ramp_test_bike', 'plank_hold'],
    optionalTests: ['peak_power_5s', 'lactate_step_test'],
...
const SWIMMING: Discipline[] = [
  {
    ...
    coreTests: ['swim_400m', 'swim_100m', 'swim_incremental'],
    optionalTests: ['pull_up_max_reps', 'grip_strength', 'plank_hold'],
  ...
  },
  {
    ...
    coreTests: ['swim_100m', 'swim_400m'],
    optionalTests: ['swim_incremental', 'plank_hold', 'pull_up_max_reps'],
  ...
  },
  {
    ...
    coreTests: ['swim_100m', 'swim_400m'],
    optionalTests: ['swim_incremental', 'countermovement_jump'],
  ...
  },
  {
    ...
    coreTests: ['swim_100m', 'pull_up_max_reps', 'plank_hold'],
    optionalTests: ['swim_400m', 'countermovement_jump'],
...
const TRIATHLON: Discipline[] = [
  {
    ...
    coreTests: ['swim_400m', 'ftp_20min', 'run_5k', 'brick_bike_run'],
    optionalTests: ['ramp_test_bike', 'threshold_run_30min'],
  ...
  },
  {
    ...
    coreTests: ['swim_400m', 'ftp_20min', 'run_10k', 'brick_bike_run'],
    optionalTests: ['ramp_test_bike', 'threshold_run_30min', 'swim_incremental'],
  ...
  },
  {
    ...
    dimensionWeights: { endurance: 1, strength_endurance: 0.8 },
    coreTests: ['swim_400m', 'ftp_20min', 'run_10k', 'brick_bike_run'],
    optionalTests: ['threshold_run_30min', 'lactate_step_test', 'plank_hold'],
  ...
  },
  {
    ...
    dimensionWeights: { endurance: 1, strength_endurance: 0.9 },
    coreTests: ['swim_400m', 'ftp_20min', 'run_10k', 'brick_bike_run'],
    optionalTests: ['threshold_run_30min', 'lactate_step_test', 'plank_hold', 'farmers_carry'],
...
const TACTICAL: Discipline[] = [
  {
    ...
    coreTests: ['run_1_5_mile', 'pull_up_max_reps', 'farmers_carry', 'shuttle_5_10_5', 'sled_drag'],
    optionalTests: ['deadlift_1rm', 'grip_strength', 'stair_climb', 'plank_hold'],
  ...
  },
  {
    ...
    coreTests: ['stair_climb', 'farmers_carry', 'sled_drag', 'deadlift_1rm', 'run_1_5_mile'],
    optionalTests: ['grip_strength', 'pull_up_max_reps', 'plank_hold'],
    eventDurationSeconds: null,
    typicalLimiter: 'strength_endurance',
  },
  {
    ...
    coreTests: ['loaded_march', 'run_1_5_mile', 'pull_up_max_reps', 'farmers_carry', 'deadlift_1rm'],
    optionalTests: ['sprint_30m', 'sled_drag', 'stair_climb', 'plank_hold'],
    eventDurationSeconds: null,
    typicalLimiter: 'strength_endurance',
  },
  {
    ...
    coreTests: ['loaded_march', 'pull_up_max_reps', 'farmers_carry', 'run_1_5_mile', 'deadlift_1rm', 'shuttle_5_10_5'],
    optionalTests: ['sled_drag', 'stair_climb', 'grip_hang_time', 'sprint_30m'],
    eventDurationSeconds: null,
    typicalLimiter: 'strength_endurance',
  },
  {
    ...
    coreTests: ['farmers_carry', 'stair_climb', 'sled_drag', 'deadlift_1rm'],
    optionalTests: ['run_1_5_mile', 'grip_strength', 'plank_hold'],
    eventDurationSeconds: null,
    typicalLimiter: 'strength_endurance',
  },
]
